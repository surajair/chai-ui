...
export const Calltoaction9 = () => {
  return (
    <>
      <div className="dark bg-gray-200 px-10 py-10 dark:bg-black dark:text-white lg:px-20 lg:py-20">
        <div className="-mt-4 bg-white pl-3  lg:py-14">
            ...
            <div className="my-auto pt-6 md:px-10 lg:pt-0">
              ...
              <div className="py-3 px-3">
                <h3 className=" leading-6 lg:text-lg">
                  ...
                  <br className="hidden lg:inline" />
                  from Sketch or Figma. You can even sync designs
                  <br className="hidden lg:inline" />
...
export default {
  title: "Marketing/CallToAction/Calltoaction 9",
  component: Calltoaction9,
};
