...
export const Feature2Dark = () =>{
    return <>
        <div className="scroll-py-20 lg:py-14 pl-14  text-white bg-black">
            <div className="lg:grid grid-cols-1 lg:grid-cols-2 flex flex-col-reverse">
                <div className="pt-2 pr-10">
                    ...
                    <div className="">
                        <div className="flex py-3">
                            <div className="bg-gray-500 rounded-full h-10 w-10 py-3 px-3">
                                <HiLocationMarker/>
                            </div>
                ...
                <div className="lg:py-10">
                    <img src="https://res.cloudinary.com/dw8gdozpq/image/upload/v1651757429/Safari1_gswzdi.png"/>
                </div>
            </div>
        </div>
    </>;
...
export default {
    title: "Marketing/Features/Feature 2 Dark",
    component: Feature2Dark,
};